    ...
    >
      <div className="container mx-auto flex flex-wrap md:flex-nowrap justify-between items-center px-4 sm:px-6 lg:px-20 py-4">
          ...
          <div className="flex items-center">
            <Link to="/">
              <img
                src={navlogo}
                alt="Logo"
                className="w-[150px] h-[50px] mr-2 object-contain"
              />
            </Link>
          </div>
        ...
        >
          <a
            href="/"
            className="block md:inline-block px-3 py-2 hover:text-teal-200 transition-colors"
          >
            HOME
          </a>
          <a
        ...
        <div
          className={`flex space-x-5 mt-4 md:mt-0 ${
            isOpen
              ? "block w-full border-t border-teal-800 pt-4 md:border-0 md:pt-0 md:flex"
              : "hidden md:flex"
          }`}
        >
          <a
            href="/my-account"
            className="hover:text-teal-200 transition-colors text-xl"
          >
            <FaUser />
          </a>
