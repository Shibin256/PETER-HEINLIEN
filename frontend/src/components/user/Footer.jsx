      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="md:col-span-1 lg:col-span-2">
            <h2 className="text-2xl font-medium mb-4 text-gray-800">PETER HENLEIN</h2>
            <p className="text-gray-500 mb-6 max-w-xs">
              Timeless craftsmanship meets modern elegance in every timepiece we offer.
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:col-span-3 lg:col-span-3">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="/about" className="text-gray-500 hover:text-teal-600 transition-colors">
                    About
                  </a>
                </li>
                <li>
                  <a href="/collection" className="text-gray-500 hover:text-teal-600 transition-colors">
                    Collection
                  </a>
                </li>  <li>
                  <a href="/about" className="text-gray-500 hover:text-teal-600 transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  ...
                  <li>
                    <a href="/contact" className="text-gray-500 hover:text-teal-600 transition-colors">
                      Help & Contact
                    </a>
                  </li>
              </ul>
        ...
        <div className="pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            COPYRIGHT © {new Date().getFullYear()} PETER HENLEIN. ALL RIGHTS RESERVED
          </p>
