      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-24 sm:py-32 lg:py-40">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <h1 className="prata-regular text-4xl md:text-5xl font-bold mb-4 text-gray-900">DISCOVER</h1>
            <h2 className="text-3xl md:text-4xl mb-8 text-gray-800">OUR COLLECTIONS</h2>
            
            <div className="border-t border-gray-300 my-8 w-3/4 lg:w-1/2 mx-auto lg:mx-0"></div>
            
            <div className="mb-8">
              <h3 className="text-xl md:text-2xl font-semibold mb-4 text-gray-700">COLLECTION PRECISION</h3>
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-6 text-lg">
              <span className="hover:text-gray-600 cursor-pointer">Velociia</span>
              <span className="hover:text-gray-600 cursor-pointer">ChronoCraft</span>
              <span className="hover:text-gray-600 cursor-pointer">Precision</span>
            </div>
          </div>
