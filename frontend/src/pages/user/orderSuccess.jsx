  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <div className="bg-white shadow-md rounded-lg p-6 mb-6">
        ...
        <p>
          <strong>Expected Delivery:</strong> {formattedDate}
        </p>
      </div>
      ...
      <div className="bg-white shadow-md rounded-lg p-6 mb-6">
        ...
        <p>
          <strong>Name:</strong> {Order_Address.name}
        </p>
        <p>
          <strong>Address Type:</strong> {Order_Address.addressType}
        </p>
        <p>
          <strong>Phone:</strong> {Order_Address.phone}
        </p>
        <p>
      ...
      <div className="bg-white shadow-md rounded-lg p-6 mb-6">
        ...
        <p className="text-lg font-semibold mt-2">
          ...
          {Number(TotalAmount) + Number(DeliveryCharge)}
        </p>
      </div>
