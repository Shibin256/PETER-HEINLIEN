      ...
      <div className="bg-white rounded-2xl shadow-md overflow-hidden mb-8">
        ...
        <div className="p-6 border-b border-[#e6f0f3]">
          <h2 className="text-xl font-bold text-[#003543] flex items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6 mr-2 text-[#00758a]"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
        ...
        <div className="p-6">
          ...
          <div className="bg-gradient-to-r from-[#f0f9ff] to-[#e0f2fe] rounded-xl p-5 mb-6 border border-[#e6f0f3]">
            <p className="text-[#003543] font-medium">
              1. Share your referral code to earn ₹50 in your wallet when
              friends sign up!
            </p>
          </div>
          ...
          <div>
            <h3 className="text-lg font-semibold text-[#003543] mb-3">
              Your Referral Code
            </h3>
            <div className="bg-white p-4 rounded-lg border border-[#e6f0f3] shadow-sm">
              <div className="flex justify-between items-center">
                <span className="font-mono font-bold text-xl text-[#005662]">
                  {user.referralCode}
                </span>
                <button
        ...
        {transactions.length === 0 ? (
          <div className="p-8 text-center">
            <div className="mx-auto w-24 h-24 bg-[#f0f9ff] rounded-full flex items-center justify-center mb-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-10 w-10 text-[#527a85]"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
            ...
            <h3 className="text-lg font-medium text-[#003543] mb-1">
              No transactions yet
            </h3>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-[#e6f0f3]">
              <thead className="bg-[#f0f9ff]">
                <tr>
                  <th className="px-6 py-3 text-left text-xs font-medium text-[#527a85] uppercase tracking-wider">
                    Transaction ID
                  </th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-[#527a85] uppercase tracking-wider">
                    Amount
              ...
              <tbody className="bg-white divide-y divide-[#e6f0f3]">
                {transactions.map((transaction) => (
                  <tr
                    ...
                    className="hover:bg-[#f7fcff] transition duration-150"
                  >
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md transform transition-all duration-300 scale-95 animate-fadeIn">
            <div className="p-6">
              ...
              <div className="mb-6">
                <label
                  htmlFor="amount"
                  className="block text-sm font-medium text-[#003543] mb-2"
                >
                  Enter Amount (₹)
                </label>
            ...
            <div className="bg-[#f0f9ff] px-6 py-4 rounded-b-2xl">
              <div className="flex items-center text-sm text-[#527a85]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5 mr-2 text-[#00758a]"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
