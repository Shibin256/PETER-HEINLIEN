      ...
      <div className="max-w-md mx-auto bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
        ...
        <div className="flex flex-col items-center mt-6 relative">
          <div className="relative group">
            <img
              src={
                user.profileImage ||
                `https://ui-avatars.com/api/?name=${nameImg[0]}+${nameImg[1]}&background=003543&color=fff&size=128`
              }
              alt="Profile"
          ...
          <h3 className="text-xl font-semibold mt-4 text-[#003543]">
            {profileData.name}
          </h3>
          ...
          <div className="bg-gray-50 px-4 py-3 rounded-lg">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="font-medium text-[#003543]">
                  {profileData.email}
                </p>
              </div>
              {/* <button
        ...
        <div className="px-6 pb-6 flex flex-col space-y-3">
          <button
            ...
            className="w-full py-3 bg-[#003543] text-white rounded-lg hover:bg-[#004d5f] transition-colors duration-300 font-medium"
          >
            LOG OUT
          </button>
          {/* <button
