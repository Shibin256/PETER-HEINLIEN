            ...
            <div className="max-w-md mx-auto bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
                ...
                <div className="flex flex-col items-center mt-6 relative">
                    <div className="relative group">
                        <img
                            src={profilePic || 'https://ui-avatars.com/api/?name=Shibin+KP&background=003543&color=fff&size=128'}
                            alt="Profile"
                            className="rounded-full w-24 h-24 object-cover border-4 border-white shadow-lg"
                        />
                        <label className="absolute inset-0 bg-black bg-opacity-50 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 cursor-pointer">
                ...
                <div className="px-6 pb-6 flex flex-col space-y-3">
                    ...
                    <button className="w-full py-2 text-sm text-red-500 hover:text-red-700 hover:bg-red-50 rounded-md transition-colors duration-300">
                        DELETE ACCOUNT
                    </button>
                </div>
            </div>
