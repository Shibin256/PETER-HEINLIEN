...
const OrdersList = () => {
  ...
  useEffect(() => {
    if (sortType) {
      dispatch(
        fetchAllOrders({ search: '', page: 1, limit: 10, sort: sortType })
      );
    } else {
  ...
  const columns = [
    ...
    },
    {
      ...
      label: 'Order Status',
      render: (status) => {
        const displayStatus = status === 'Processing' ? 'Placed' : status;
      ...
      render: (_, item) => (
        <div className="flex space-x-2">
          <button
            ...
            onClick={() =>
              setSelectedOrderId(item._id === selectedOrderId ? null : item._id)
            }
          >
  ...
  const renderActions = (item) => (
    <div className="flex justify-end">
      ...
      {item.OrderStatus === 'Delivered' &&
        item.Items.some((i) => i.returnReason && !i.returnVerified) && (
          <button
            onClick={() => {
              setCurrentOrder(item);
              setSelectedReturnItem(
                item.Items.find((i) => i.returnReason && !i.returnVerified)
              );
          ...
          <button
            onClick={() => {
              ...
              setSelectedCancelItem(
                item.Items.find((i) => i.cancelReason && !i.cancelVerified)
              );
              ...
              <div className="p-6">
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg space-y-2">
                      <p>
                        ...
                        {orderDetails.Order_Address?.name}
                      </p>
                      <p>
                        <span className="font-medium">Phone:</span>{' '}
                        {orderDetails.Order_Address?.phone}
                      </p>
                      <p>
                ...
                <div className="mt-6">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <p>
                      {orderDetails.Order_Address?.house},
                      {orderDetails.Order_Address?.locality},{' '}
                      {orderDetails.Order_Address?.city}
                    </p>
                    <p>
                      {orderDetails.Order_Address?.state} -{' '}
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
              <div className="p-6">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="font-medium">
                        {selectedCancelItem.productName}
                      </p>
                      <p className="text-sm text-gray-600">
                        ₹{selectedCancelItem.productPrice?.toFixed(2)} ×{' '}
                ...
                <div className="mb-4">
                  ...
                  <p className="bg-gray-50 p-3 rounded-md">
                    {selectedCancelItem.returnReason}
                  </p>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <p className="text-lg font-bold">
                    ₹{selectedCancelItem.subTotal?.toFixed(2)}
                  </p>
                </div>
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-yellow-700">
                        Please confirm that you have received the returned item
                        in good condition before verifying this return.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 px-6 py-4 flex justify-end space-x-3">
                ...
                <button
                  onClick={() =>
                    handleVerifySingleCancel(
                      currentOrder._id,
                      selectedCancelItem.itemOrderId
                    )
                  }
                  className="px-4 py-2 bg-green-600 hover:bg-green-700 rounded-md text-sm font-medium text-white"
                >
            ...
            <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
              <div className="p-6">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        ₹{selectedReturnItem.productPrice?.toFixed(2)} ×{' '}
                ...
                <div className="mb-4">
                  ...
                  <p className="bg-gray-50 p-3 rounded-md">
                    {selectedReturnItem.returnReason}
                  </p>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <p className="text-lg font-bold">
                    ₹{selectedReturnItem.subTotal?.toFixed(2)}
                  </p>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  Are you sure you want to verify this cancellation?
                </p>
              </div>
              <div className="bg-gray-50 px-6 py-4 flex justify-end space-x-3">
                <button
